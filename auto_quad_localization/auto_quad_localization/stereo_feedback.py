...
class StereoSplitter(Node):
    def __init__(self):
        ...
        self.left_gray_pub = self.create_publisher(Image, '/left/image_gray', 10)
        self.right_color_pub = self.create_publisher(Image, '/right/image_raw', 10)
        self.right_gray_pub = self.create_publisher(Image, '/right/image_gray', 10)
